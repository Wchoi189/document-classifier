...
class WrongPredictionsExplorer:
    ...
    def generate_html_report(self, wrong_preds: pd.DataFrame, patterns: Dict, 
                           confidence_analysis: Dict, output_filename: str = None):
        """HTML 보고서 생성"""
    ...
    def generate_comprehensive_analysis(self, predictions_csv: str, ground_truth_csv: str = None):
        """종합 오분류 분석 실행"""
        print("🚀 종합 오분류 분석 시작...")
        ...
        analysis_results = {
            ...
            'summary': {
                'total_wrong_predictions': len(wrong_preds),
                'most_confused_classes': patterns.get('confusion_pairs', [])[:5],
        ...
        print(f"🖼️ 갤러리: {gallery_path if 'gallery_path' in locals() else 'N/A'}")
